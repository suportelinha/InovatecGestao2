-- ==============================================================================
-- INOVATEC - Sistema Completo de Gestão de Estoque, Vendas e Relatórios
-- Schema SQL Oficial para PostgreSQL / Supabase
-- ==============================================================================
...
-- 4. TABELA: PRODUCTS (Catálogo e Inventário de Produtos)
...
-- 5. TABELA: STOCK_ENTRIES (Entradas / Compras de Mercadorias)
...
-- 6. TABELA: SALES (Vendas e Faturamento)
...
-- 7. TABELA: STOCK_EXITS (Saídas / Baixas / Avarias de Estoque)
...
-- 10. POLÍTICAS DE ACESSO (RLS - Cada usuário vê e altera apenas seus próprios dados)
-- PROFILES
...
-- 11. TRIGGER PARA CRIAR PERFIL AUTOMATICAMENTE NO CADASTRO
...
-- 12. BUCKET DE ARMAZENAMENTO PARA FOTOS DE PRODUTOS
